...
- (void)layoutSubviews
{
    ...
    _explainLabel.frame = CGRectMake((viewWidth - explainLabelWidth)/2, CGRectGetMaxY(_numberLabel.frame)-numberLabelHeight/30+10, explainLabelWidth, explainLabelHeight);
}
