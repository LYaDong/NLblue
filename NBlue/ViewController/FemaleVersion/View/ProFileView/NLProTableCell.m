...
-(void)buildUI{
    ...
    self.imageArrow = [[UIImageView alloc] initWithFrame:CGRectMake(SCREENWIDTH - [ApplicationStyle control_weight:24] - [ApplicationStyle control_weight:16], (y - [ApplicationStyle control_height:24])/2, [ApplicationStyle control_weight:16], [ApplicationStyle control_height:24])];
    [self.contentView addSubview:self.imageArrow];
    
    self.line = [[UIView alloc] initWithFrame:CGRectMake(x, [ApplicationStyle control_height:88] - [ApplicationStyle control_height:2], SCREENWIDTH - x, [ApplicationStyle control_height:1])];
