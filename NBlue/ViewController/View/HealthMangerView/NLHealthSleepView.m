...
-(void)buildUI{
    ...
    ring.backColors = [@"f7f3ff" hexStringToColor];
    ring.coverColor = [@"ffde6a" hexStringToColor];
    ring.lineWidth = [ApplicationStyle control_weight:30];
    ring.lineIndex = 100;
    ring.progressCounter = 30;
    ring.radius = [ApplicationStyle control_weight:200];
