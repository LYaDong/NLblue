...
+(void)blueSportOrdinArrayData:(NSArray *)arr{
    ...
    arr = @[@"08030110e007021000000f602200",
            @"08030210110b000069000000bf0700001a070000",
            ...
            @"0803110f00000000006cc533200f0495c9e03a00",
            @"0803120f004002000000000000006cc321900900",
            @"0803130fa84539e00f0000020000000000000000",
            @"0803140f00000000000040010000a0442df00c00",
            @"0803150f00000000000000000000000000000000",
            @"0803160f20042a900b0000000000008002000000",
...
//    Byte *testByte = [self stringConversionByte:@"0f3c0003a0"];
...
//    //计算时间
    ...
    NSString *totalTime = [arr[1] substringWithRange:NSMakeRange(8 * 4, 8)];
    NSString *totalTimeCount = [NSString stringWithFormat:@"%ld",[self sixTenHexTeen:[self reversedPositionStr:totalTime]]];
    ...
    [dicSportDataBig setValue:totalTimeCount forKey:@"totalTimeCount"];
...
//    arr = @[@"08040110e0070210072458010a04",
//            @"08040210100500ff005900000804",
//            @"080403100250030902280321020d03100214031f",
//            @"0804040402660100000000000000000000000000"];
...
//    08040210 06 04 01 5c005000000804,
    ...
    NSLog(@"%@",sleepDataArray);
    [NLSQLData upDataSleep:sleepDataArray isUpdata:0];
